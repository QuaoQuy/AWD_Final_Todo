    ...
    @forelse($todos as $todo)
        <div
                ...
                @else
                    <div class="flex flex-col">
                        <div class="flex items-center">
                            ...
                            @endif
                            <span @if ($todo->is_completed) class='line-through font-medium' @endif
            ...
            <div>
                ...
                @else
                    <button
                        @if ($todo->is_completed) class="bg-slate-400 text-white px-4 py-2 rounded-md" @endif
                    ...
                    <button wire:click='editTodo({{ $todo->id }})'
                        class="bg-indigo-500 text-white px-4 py-2 rounded-md">Edit</button>
